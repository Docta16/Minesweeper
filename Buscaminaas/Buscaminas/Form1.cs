    ...
    public partial class Form1 : Form
    {
        ...
        private void iniciarPartida()
        {
            ...
            else
            {
                ...
                BotonesNumerados bn = new BotonesNumerados(ip.Numero, ip.Dificultad, this.imageList1);
                this.bn = bn;
                this.bn.PropertyChanged += new PropertyChangedEventHandler(this.notificacionCambio);
        ...
        /// <summary>
        /// Método que responde a los cambios realizados por el buscaminas.
        /// </summary>
        /// <param name="sender">Objeto que desencadena el evento.</param>
        /// <param name="e">Información sobre el evento.</param>
        private void notificacionCambio(object sender, PropertyChangedEventArgs e)
        {
            if(e.PropertyName == "minas")
            {
                this.tbMinas.Text = bn.Minas.ToString();
            }
            if(e.PropertyName == "muerto")
            {
                this.timer.Stop();
                this.bttIniciar.BackgroundImage = this.imageList1.Images[1];   //Pone la carita triste
            }
            if(e.PropertyName == "fin")
            {
                this.timer.Stop();
            }
        }
