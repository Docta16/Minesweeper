...
namespace Ejercicio_1
{
    ...
    /// </summary>
    public partial class BotonesNumerados: UserControl, INotifyPropertyChanged
    {
        /// <summary>
        ...
        /// <summary>
        /// Evento que se lanzara con la interfaz InotifyPropertyChanged
        /// </summary>
        public event PropertyChangedEventHandler PropertyChanged;

        /// <summary>
        /// Genera un evento para indicar que el valor de una propiedad ha cambiado.
        /// </summary>
        ...
        public BotonesNumerados(int n, int dif, ImageList img)
        {
            this.casillas = img;
            this.n = n;
            InitializeComponent();
